defmodule Khf1 do
  ...
  @spec szur_es_rendez(ertekek :: ertekek(), celertek :: non_neg_integer()) :: r :: [{pos_integer(), non_neg_integer()}]
  ...
  @spec lnko_lista(lista :: [pos_integer()]) :: r :: pos_integer()
  ...
  @spec ellenoriz_es_skalaz(parok :: [{pos_integer(), non_neg_integer()}], celertek :: non_neg_integer()) :: r ::
  ...
  @spec dp_inicializal(celertek :: non_neg_integer()) :: r :: :array.array()
  ...
  @spec effektiv_limit(darab :: non_neg_integer(), ertek :: pos_integer(), celertek :: non_neg_integer()) :: r :: non_neg_integer()
  ...
  @spec dp_egy_ertekkel(:array.array(), pos_integer(), non_neg_integer(), non_neg_integer()) :: r :: :array.array()
  ...
  @spec dp_frissit_minden_ertekkel(:array.array(), [{pos_integer(), non_neg_integer()}], non_neg_integer()) :: r :: :array.array()
